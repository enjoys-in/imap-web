            ...
            >
                <div className="text-center py-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <h2 className="mt-1 sm:mt-3 text-4xl font-bold text-white sm:text-6xl">
                        <span className="bg-clip-text bg-linear-to-tr from-blue-600 to-purple-400 text-transparent">
                            Deploy 
                        </span>
                    </h2>
                    <form>
                        <div className="mt-8 space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="py-2.5 sm:py-3 ps-11 pe-4 block w-full bg-white/10 border-white/20 text-white placeholder:text-white rounded-lg sm:text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11"
                            ...
                            <div className="grid">
                                <button
                                    type="submit"
                                    className="sm:p-4 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-white/10 text-white hover:bg-white/20 focus:outline-hidden focus:bg-white/20 disabled:opacity-50 disabled:pointer-events-none"
                                >
                                    Join the waitlist
                                    <svg
