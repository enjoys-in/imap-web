  ...
  return (
    <div className="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
      <div className="block md:max-w-lg">
        <Image src="/404.svg" alt="astronaut image" width={500} height={500} />
      </div>
      <div className="text-center xl:max-w-4xl">
        ...
        <Button onClick={() => router.back()} className="text-slate-800 dark:text-neutral-200 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
